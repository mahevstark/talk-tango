...
export default function profile() {
  ...
  return (
    <SidebarLayout>
      <div className="flex sm:flex-row flex-col sm:mt-0 mt-1.5 gap-4 w-full   mr-6">
        ...
        <div className="flex w-full bg-white  pt-4 sm:flex-row flex-col border shadow-lg rounded-lg  min-h-screen px-8 my-4  overflow-scroll scrollbar-hide  ">
          {/* Left Sidebar */}
          {/* <LeftLayoutMessages /> */}
...

                {
                  paymentData.map((day, index) => (
                    <div key={index} className="mb-4">
                      <div
                        key={index}
                        className="flex sm:items-center sm:justify-between w-full flex-col justify-start items-start gap-4 sm:gap-0 sm:flex-row "
                      >
